...
// 		e("#morris-line-example").empty(), e("#morris-area-example").empty(), e("#morris-area-with-dotted").empty(), e("#morris-bar-example").empty(), e("#morris-bar-stacked").empty(), e("#morris-donut-example").empty();
...
// 			b: 90,
// 			c: 60
// 		}], "y", ["a", "b", "c"], ["Series A", "Series B", "Series C"], ["#ff8acc", "#5b69bc", "#35b8e0"]);
...
// 			a: 100,
// 			b: 90
// 		}], "y", ["a", "b"], ["Series A", "Series B"], ["#71b6f9", "#ebeff2"]);
...
// 	"use strict";
// 	a.MorrisCharts.init(), window.addEventListener("adminto.setBoxed", function(e) {
// 		a.MorrisCharts.init()
